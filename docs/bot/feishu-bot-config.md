...
- App Bot 发送路径复用 `pyproject.toml` 中已声明的 `lark-oapi>=1.0.0`，标准安装使用 `uv sync --frozen`；参考 [Feishu message create OpenAPI](https://open.feishu.cn/document/server-docs/im-v1/message/create)、[lark-oapi PyPI](https://pypi.org/project/lark-oapi/) 和 [SDK repo](https://github.com/larksuite/oapi-sdk-python)
